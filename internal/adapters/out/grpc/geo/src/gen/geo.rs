...
pub struct GetGeolocationReply {
...
pub mod geo_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_geolocation(
            &mut self,
            request: impl tonic::IntoRequest<super::GetGeolocationRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetGeolocationReply>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let path = http::uri::PathAndQuery::from_static("/geo.Geo/GetGeolocation");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("geo.Geo", "GetGeolocation"));
